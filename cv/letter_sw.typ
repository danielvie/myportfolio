...
#show: layout(
    [
        ...
        I am excited to submit my application for the Senior Software Engineer position at Philips. I am a control systems engineer with over 10 years of experience in the aerospace industry working with control, guidance, navigation, and Model-Based Design using Matlab/Simulink and I have solid programming skills in C/C++/Python for embedded systems.
