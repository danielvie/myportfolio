    ...
    return (
        <>
            <ExperienceBlock
                ...
                text="
                    As a Software Designer, I am responsible for designing
                    software in the scope of High Tech industry. I was initially
                    assigned to the ASML team integrating a suite of software
                    facilities in their YieldStar project, integrating and
                    testing new and updated networks into the running code. My
                    background and experience with Model-Based Design gave me
                    the tools to work in the innovation projects in ICT that is
                    implementing Model-Based Testing in the High Tech industry
                    domain, which allowed me to join the team that is applying
                    Model-Based Testing inside of Thermo Fisher to test the
                    software that is embedded in their microscopes. My role is
                    to develop models that describe the behavior of the systems
                    under test using the Axini Model Language, this model then
                    generates automatic tests cases based on the relationships
                    and behaviors of the system. In this role I have to discuss
                    with several team about their requirements and how to best
                    describe their system so the models can reflect the real
